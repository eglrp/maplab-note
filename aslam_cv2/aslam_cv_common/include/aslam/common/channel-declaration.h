...
//比如这里TYPE是Eigen::Matrix2Xd,那么DECLARE_CHANNEL(VISUAL_KEYPOINT_MEASUREMENTS, Eigen::Matrix2Xd)
//VISUAL_KEYPOINT_MEASUREMENTS_ChannelValueType就是Mat2d
