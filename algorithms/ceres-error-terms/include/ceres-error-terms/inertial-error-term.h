...
struct ImuIntegration {
  ...
  Eigen::LLT<InertialStateCovariance> L_cholesky_Q_accum;//为了计算马氏距离？
...
class InertialErrorTerm//初始化imu残差因子的代价函数
    : public ceres::SizedCostFunction<imu_integrator::kErrorStateSize,//<15,7,3,3,3,7,3,3,3>
 ...
 public:
  InertialErrorTerm(
      ...
      : imu_timestamps_(imu_timestamps),
        imu_data_(imu_data),//加速度数据，角加速度数据
