...
class LocalizationSummaryMap {
 ...
 private:
  ...
  /// The position of the landmarks in the global frame of reference.//地标在全球参照系中的位置。
  ...
  /// The position of the observers in the global frame of reference.//观察员在全球范围内位置
  Eigen::Matrix3Xf G_observer_position_;
  /// A set of projected_descriptors from observations of landmarks.一组从地标观测中投射出来的描述符。
